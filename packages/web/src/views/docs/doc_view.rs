        ...
        Some(parsed) => {
            rsx! {
                    ...
                    div { class: "flex flex-col gap-2",
                        ...
                        div {
                            class:"doc-content [class:"[&>*>pre]:p-4 mt-12 [&>*>pre]:rounded-md [&>*>pre]:bg-code! [&>*>pre]:text-code-foreground space-y-4">*>pre]:p-4 mt-12 [class:"[&>*>pre]:p-4 mt-12 [&>*>pre]:rounded-md [&>*>pre]:bg-code! [&>*>pre]:text-code-foreground space-y-4">*>pre]:rounded-md [class:"[&>*>pre]:p-4 mt-12 [&>*>pre]:rounded-md [&>*>pre]:bg-code! [&>*>pre]:text-code-foreground space-y-4">*>pre]:bg-code! [class:"[&>*>pre]:p-4 mt-12 [&>*>pre]:rounded-md [&>*>pre]:bg-code! [&>*>pre]:text-code-foreground space-y-4">*>pre]:text-code-foreground space-y-4 [class:"[&>*>pre]:p-4 mt-12 [&>*>pre]:rounded-md [&>*>pre]:bg-code! [&>*>pre]:text-code-foreground space-y-4">pre]:overflow-x-auto",
                        Markdown {
